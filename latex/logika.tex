...
\begin{definition}[Relacija \(\mathit{Prem}\)]
...
\begin{definition}[Međusobna zavisnost]
...
\begin{lemma}
  Međusobna zavisnost je relacija ekvivalencije na skupu induktivnih predikatnih simbola. \misao{Ova lema zvuči kao da je bitna, ali čini mi se da nije.}
\begin{minted}{coq}
...
\misao{Rado bih koristio nešto što nije \texttt{figure} za pravila izvoda, ali ne znam što.}

Strukturalna pravila su prikazana u slici~\ref{fig:lkid-structural}, a služe baratanju strukture sekvenata,
...
Propozicijska pravila prikazana su na slici~\ref{fig:lkid-propositional},
a odnose se na propozicijski dio logike \(\mathit{FOL_{ID}}\), odnosno na negaciju i implikaciju. \misao{Treba li tu neka motivacija? Ja bih rekao da ne.}
\begin{figure}[!htb]
  \centering
  \begin{prooftree}
    \AxiomC{\( \Gamma \vdash \varphi, \Delta \)}
